    ...
    <div class="wrapper">
        ...
        document.getElementById('logout-form').submit();">
                ...
                <ul class="nav nav-treeview">
                    {{-- <li><a href="{{ url('/rol') }}" --}}
                    {{-- class="link-light  text-decoration-none rounded fs-5 text-dark px-3">Create Account</a></li> --}}
                    {{-- <li><a href="{{ url('userv') }}" --}}
                    {{-- class="link-light  text-decoration-none rounded fs-5 text-dark px-3">All Users</a></li> --}}
                </ul>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="image">
                     ...
                     @endforeach --}}
                    <div class="info">
                      <strong><a href="#" class="d-block text-decoration-none">Welcome {{ Auth::user()->name }}</a></strong>  
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ url('addcat') }}" class="nav-link">
                                <i class="nav-icon fas fa-home"></i>
                                <p>
                                    Add Category
                                    <i class="right fas fa-angle-left"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('prods') }}" class="nav-link">
                                <i class="nav-icon fas fa-home"></i>
                                <p>
                                    Products
                                    <i class="right fas fa-angle-left"></i>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">E-Shop</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
